...
// full speed.
const uint16_t turnSpeedMin = 400;  //old min speed is 50

// The maximum speed to drive the motors while moving forward.
const uint16_t moveSpeedMax = 400;
...
void loop() {
  ...
  if (objectSeen) {
      ...
      ledYellow(0);
      Serial.print("No Object Seent\n");
      
      if (senseDir == RIGHT) {
        turnRight();
        Serial.print("No Object Seent Turn Right\n");
      }
      else {
        turnLeft();
        Serial.print("No Object Seent Turn Left\n");
      }
    }  

/////////////////////////////////////////////////////////////OLED DISPLAY DATA/////////////////////////////////////////////////////////////

  Serial.print("OLED Front Sensor DISPLAY\n");
  ...
  Serial.print("OLED Line Sensor DISPLAY\n");
